    ...
    <div>
      ...
      >
        <div
         ...
         hover:scale-105 p-2 md:p-8 lg:p-12 overflow-auto rounded-lg"
        >
          <p>
            <span className="font-bold text-4xl">🎉 Congratulations 🎉</span>
            <span>
              You won new iphone 17 max pro turbo ultra hd xd lol! <br />
              Everything to get your iphone is give me pic of revers and avers
              your credit card
            </span>
          </p>
        </div>
